...
const DtRegister = ({ setUser, user, setMenuIndex }) => {
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <div style={{ margin: '50px auto', overflow: 'hidden' }}>
...
export default connect(mapStateToProps, mapActionToProps)(DtRegister);
